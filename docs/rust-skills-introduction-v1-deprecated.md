...
> 一个专为 Codex 打造的 Rust 开发辅助插件，通过元问题导向、动态 Skills 和精准文档获取，显著提升 AI 编写 Rust 代码的质量。
...
**仓库地址**：[https://github.com/Uber-Eins/rust-skills](https://github.com/Uber-Eins/rust-skills)
