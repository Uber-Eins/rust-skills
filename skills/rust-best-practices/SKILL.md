...
description: >
  Comprehensive Rust best-practice rule library with 265 rules across 26
  categories. Use when writing, reviewing, or refactoring Rust code for
  idiomatic ownership, error handling, async, concurrency, unsafe, API design,
  memory, performance, numeric safety, serde, testing, docs, linting, and
  anti-pattern checks. Complements coding-guidelines for detailed rule lookup.
...
metadata:
  author: leonardomso
  version: "1.5.1"
  integrated_as: rust-best-practices
  upstream_repository: https://github.com/leonardomso/rust-skills
  sources:
    - Rust API Guidelines
...
# Rust Best Practices Rule Library

Imported from `leonardomso/rust-skills` and integrated as
`rust-best-practices` for this Codex plugin. See `LICENSE.upstream` for the
upstream MIT license.

Comprehensive guide for writing high-quality, idiomatic, and highly optimized
Rust code. Contains 265 rules across 26 categories, prioritized by impact to
guide LLMs in code generation and refactoring.
